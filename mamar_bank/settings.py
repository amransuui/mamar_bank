...
# SECRET_KEY = 'django-insecure-yyuh_s2z#q8z@9lpq%1txk&qtrn(hh!^3a4%^8lfo@g)wn8yie'
SECRET_KEY="django-insecure-rcc&boli^q12d$fa8=^1tp3td3z_i-xsdy#(f@3*uee24bkk+g"
# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = ['https://mamar-bank-10kx.onrender.com','https://*.127.0.0.1']
